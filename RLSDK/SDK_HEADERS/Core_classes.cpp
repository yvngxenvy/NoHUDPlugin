...
// [0xFFFFFFFFFFFFFFFF] (FUNC_Final | FUNC_Defined | FUNC_Iterator | FUNC_Latent | FUNC_PreOperator | FUNC_Singular | FUNC_Net | FUNC_NetReliable | FUNC_Simulated | FUNC_Exec | FUNC_Native | FUNC_Event | FUNC_Operator | FUNC_Static | FUNC_NoExport | FUNC_OptionalParm | FUNC_Const | FUNC_Invariant | FUNC_Public | FUNC_Private | FUNC_Protected | FUNC_Delegate | FUNC_NetServer | FUNC_HasOutParms | FUNC_HasDefaults | FUNC_NetClient | FUNC_DLLImport | FUNC_K2Call | FUNC_K2Override | FUNC_K2Pure | FUNC_EditorOnly | FUNC_Lambda | FUNC_NetValidate | FUNC_AllFlags)
// Parameter Info:
// class FString                  ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink)
// class FString                  Key                            (CPF_Parm | CPF_NeedCtorLink)
